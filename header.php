					...
					<section class="layout">
						...
						<div class="site-logo-for-tablet">
							...
							<a class="site-url" href="<?php echo get_bloginfo('url'); ?>">
								<img class="site-logo" src="<?php echo get_template_directory_uri();?>/images/patiab-logo-mobile.png" alt="<?php echo get_bloginfo('url'); ?>"/>
				...
				<nav role="navigation" class="main-menu" itemscope="" itemtype="http://schema.org/SiteNavigationElement">
					<section class="layout">
						...
						<div class="site-logo-contianer">
							...
							<a class="site-url" href="<?php echo get_bloginfo('url'); ?>">
								<img class="site-logo" src="<?php echo get_template_directory_uri();?>/images/patiab-logo.png" alt="<?php echo get_bloginfo('url'); ?>"/>
						...
						<div class="search-form-wrapper">
							<div class="search-area">
								<?php echo patiab_menu_search_form(); ?>
							</div>
						</div>
						...
						<?php wp_nav_menu(array(
	    					         ...
	    					         'menu' => __( 'Main Menu', 'patiab' ),  // nav name
